...
\begin{align*}
	...
	L_2 &= \input{Mehrfachreflexion/build/L2} 
\end{align*}
...
\begin{align*}
	\Gamma_{12} &=  \input{Mehrfachreflexion/build/Gamma12.tex}\notag \\
	\Gamma_{21} &=  \input{Mehrfachreflexion/build/Gamma21.tex}\notag \\
	\Gamma_E &= \input{Mehrfachreflexion/build/GammaE.tex}\notag \quad,
\end{align*}
...
\begin{align*}
	R_1 &= \input{Laplace/build/R_geschlossen.tex} \\	
	L _1&= \input{Laplace/build/L_geschlossen.tex} \\
	l_1 &= \input{Laplace/build/lange_geschlossen.tex} \\
	R_2&= \input{Laplace/build/R_offen.tex} \\
	C_2 &= \input{Laplace/build/C_offen.tex}	\\
	l_2 &= \input{Laplace/build/lange_offen.tex} \quad.
\end{align*}
...
\begin{figure}
	\centering
\begin{tabular}{l|l}
	Box 1   & $R=  \input{Box25/build/R.tex}$ \\
		& $C = \input{Box25/build/C.tex}$ \\
	\hline  Box 2 &  $R = \input{Box23/build/R.tex}$ \\
	& $L = \input{Box23/build/L.tex}$\\ 
	\hline  Box 3 & $R = \input{Box28/build/R.tex}$ \\
	&$L  = \input{Box28/build/L.tex}$ \\ 
