...
write('Mehrfachreflexion/build/U0.tex', make_SI(U0.nominal_value, r'\kilo\volt', figures = 1))
write('Mehrfachreflexion/build/U1.tex', make_SI(U1.nominal_value, r'\kilo\volt', figures = 1))
write('Mehrfachreflexion/build/U2.tex', make_SI(U2.nominal_value, r'\kilo\volt', figures = 1))
write('Mehrfachreflexion/build/U3.tex', make_SI(U3.nominal_value, r'\kilo\volt', figures = 1))
...
write('Mehrfachreflexion/build/Gamma12.tex', make_SI(Gamma12.nominal_value, r'', figures = 1))
write('Mehrfachreflexion/build/Gamma21.tex', make_SI(Gamma21.nominal_value, r'', figures = 1))
write('Mehrfachreflexion/build/GammaE.tex', make_SI(GammaE.nominal_value, r'', figures = 1))
