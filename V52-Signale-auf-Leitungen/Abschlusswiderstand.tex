...
\begin{align}
	a &= \input{Box25/build/a.tex} \\
	b &= \input{Box25/build/b.tex} \\
	c &= \input{Box25/build/c.tex} \\
	d &= \input{Box25/build/d.tex} \\
	e &= \input{Box25/build/e.tex} 
\end{align}
Daraus ergibt sich für den Widerstand und die Kapazität:
\begin{align}
	R &= \frac{Z_0}{b} - Z_0 = \input{Box25/build/R.tex} \\
	C &= \frac{1}{ c (r + Z_0) \cdot 10^9} = \input{Box25/build/C.tex} \quad.
\end{align}
...
\begin{align}
	a &= \input{Box23/build/a.tex} \\
	b &= \input{Box23/build/b.tex} \\
	c &= \input{Box23/build/c.tex} \\
	d &= \input{Box23/build/d.tex} \\
	e &= \input{Box23/build/e.tex} 
\end{align}
Daraus ergibt sich hier für den Widerstand und die Induktivität:
\begin{align}
	R &= \frac{Z_0}{b} - Z_0 = \input{Box23/build/R.tex} \\
	L &= \frac{1}{ c (r + Z_0) \cdot 10^9} = \input{Box23/build/L.tex} \quad.
\end{align}
...
\begin{align}
	a &= \input{Box28/build/a.tex} \\
	b &= \input{Box28/build/b.tex} \\
	c &= \input{Box28/build/c.tex} \\
	d &= \input{Box28/build/d.tex} \\
	e &= \input{Box28/build/e.tex} 
\end{align}
Auch für diese Abschlussimpedanz wird der Widerstand und die Induktivität berechnet:
\begin{align}
	R &= \frac{Z_0}{b} - Z_0 = \input{Box28/build/R.tex} \\
	L &= \frac{1}{ c (r + Z_0) \cdot 10^9} = \input{Box28/build/L.tex} \quad.
\end{align}
