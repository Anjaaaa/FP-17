...
\begin{align}
	a &= \input{Laplace/build/a_geschlossen.tex} \\
	b &= \input{Laplace/build/b_geschlossen.tex} \\
	c &= \input{Laplace/build/c_geschlossen.tex} \\
	d &= \input{Laplace/build/d_geschlossen.tex} \\
	e &= \input{Laplace/build/e_geschlossen.tex} 
\end{align}
...
\begin{align}
	R &= \frac{Z_0}{b} - Z_0 = \input{Laplace/build/R_geschlossen.tex} \\
	L &= \frac{R + Z_0}{ c \cdot 10^9} = \input{Laplace/build/L_geschlossen.tex}
\end{align}
...
\begin{align}
		a &= \input{Laplace/build/a_offen.tex} \\
		b &= \input{Laplace/build/b_offen.tex} \\
		c &= \input{Laplace/build/c_offen.tex} \\
		d &= \input{Laplace/build/d_offen.tex} \\
		e &= \input{Laplace/build/e_offen.tex} 
\end{align}
Es lassen sich die Kapazität $C$ des Kabels ebenso die der Widerstand $R$ aus den Parametern berechnen 
\begin{align}
	R &= \frac{Z_0}{b} - Z_0 = \input{Laplace/build/R_offen.tex} \\
	C &= \frac{1}{ c (r + Z_0) \cdot 10^9} = \input{Laplace/build/C_offen.tex} \quad.
\end{align}
...
\begin{equation}
	v = \frac{c_{\textrm{Licht}}}{\sqrt{(\epsilon_r)}} = \frac{c_{\textrm{Licht}}}{\sqrt{(2.25)}} = \input{Laplace/build/v.tex}
\end{equation}
...
\begin{align}
	l_{\textrm{geschlossen}} &= \input{Laplace/build/lange_geschlossen.tex} \\
	l_{\textrm{offen}} &= \input{Laplace/build/lange_offen.tex}
\end{align}
