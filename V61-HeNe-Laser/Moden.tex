...
\todo{Entweder müssen wir hier auch den First Guess in die Abbildungen machen oder oder oben bei der Polarisation auch nicht.}
...
\begin{align}
	I_\text{0l} &= \input{build/TEM_01_d.tex} \\
	x_\text{0l} &= \input{build/TEM_01_c.tex} \\
	I_\text{0r} &=  \input{build/TEM_01_a.tex} \\
	x_\text{0r} &= \input{build/TEM_01_e.tex} \\
	\omega &=  \input{build/TEM_01_b.tex} \ .
\end{align}
...
\input{build/tab_TEM_01_gesamt.tex}